document.addEventListener('DOMContentLoaded', function() {
    ...
    const vocabulary = [
        ...
        { polish: "lubiec", spanish: "gusta -n" },
        { polish: "uwielbiac", spanish: "encanta -n" },
        { polish: "boli", spanish: "duele -n" },
        { polish: "wazny/obchodzic", spanish: "importa -n" },
        { polish: "interesuja", spanish: "interesa -n" },
        { polish: "wydawac sie", spanish: "parece -n" },
        { polish: "ladna", spanish: "bonita" },
        { polish: "nauka/science", spanish: "ciencia" },
        { polish: "halas", spanish: "ruido" },
        { polish: "zaskoczylo i spodobalo", spanish: "flipa -n" },
        { polish: "spodobalo i rozsmieszylo", spanish: "chifla -n" },
        { polish: "lubie/fajne-to", spanish: "mola -n" },
        { polish: "jablka", spanish: "manzanas" },
        { polish: "filmy", spanish: "peliculas" },
        { polish: "isc/jechac", spanish: "ir" },
        { polish: "mroz/zimno", spanish: "frio" },
        { polish: "wiewiorka", spanish: "ardilla" },
        { polish: "smieszna", spanish: "graciosa" },
        { polish: "gryzc/kluc", spanish: "picar" },
        { polish: "dziob", spanish: "el pico" },
        { polish: "slodkich snow", spanish: "dulces suenos" },
        { polish: "miec", spanish: "tener" },
        { polish: "tutaj", spanish: "aqui" },
        { polish: "wczoraj", spanish: "ayer" },
        { polish: "oplacalne", spanish: "rentable" },
        { polish: "dzik", spanish: "jabali" },
        { polish: "niezywy", spanish: "muerto" },
        { polish: "tez", spanish: "tampbién" },
        { polish: "tez nie", spanish: "tampoco" },
        { polish: "posluszny", spanish: "obedientes" },
        { polish: "bardzo", spanish: "muy" },
        { polish: "plywac", spanish: "nadar" },
        { polish: "dzielic sie", spanish: "compartir" },
        { polish: "lody", spanish: "helados" },
        { polish: "smaczne", spanish: "ricos" },
        { polish: "bardzo smaczne", spanish: "muy ricos" },
        { polish: "watpliwosc", spanish: "duda" },
        { polish: "pulapka", spanish: "trampa" },
        // Add more pairs here
    ];
